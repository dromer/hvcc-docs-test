...
The documentation is built with [MkDocs](https://www.mkdocs.org/) and [mike](https://github.com/jimporter/mike) for versioning.

To preview existing documentation locally:
...
To build a new version locally:

```bash
# Deploy current version locally
